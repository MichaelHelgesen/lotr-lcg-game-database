                    ...
                    <Grid columns={[1, 1, 2, 3]} gap={[1, 1, 2, 3]} padding={0}>
                      {card.threat ? (
                        <Card radius={2} shadow={1} tone="primary" padding={3}>
                          <Text align="center">Threat: {card.threat}</Text>
                        </Card>
                      ) : null}
                      {card.cost ? (
                        <Card radius={2} shadow={1} tone="primary" padding={3}>
                          <Text align="center">Cost: {card.cost}</Text>
                        </Card>
                      ) : null}
                      {card.willpower ? (
                        <Card radius={2} shadow={1} tone="primary" padding={3}>
                      ...
                      {card.attack ? (
                        <Card radius={2} shadow={1} tone="primary" padding={3}>
                          <Text align="center">Attack: {card.attack}</Text>
                        </Card>
                      ) : null}
                      {card.defense ? (
                        <Card radius={2} shadow={1} tone="primary" padding={3}>
                          <Text align="center">Defense: {card.defense}</Text>
                        </Card>
                      ) : null}
                      {card.health ? (
                        <Card radius={2} shadow={1} tone="primary" padding={3}>
                          <Text align="center">Hitpoints: {card.health}</Text>
                        </Card>
                      ) : null}
                    </Grid>
                    <Text>
